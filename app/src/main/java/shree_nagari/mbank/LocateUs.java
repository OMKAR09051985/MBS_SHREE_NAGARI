...
public class LocateUs extends FragmentActivity implements LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Log.e("Shubham", "Locateus_Oncreate");
			...
			if (flag == 0) {
				Log.e("Shubham", "CallWebServiceGetBnkBrnMapInfo_Calling");
    ...
    class CallWebServiceGetBnkBrnMapInfo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            try {
				...
				Log.e("Shubham", "CallWebServiceGetBnkBrnMapInfo_Request--->"+jsonObj.toString());
        ...
        protected void onPostExecute(Void paramVoid) {
            ...
            try {
				...
				Log.e("Shubham", "CallWebServiceGetBnkBrnMapInfo_Responce---->"+jsonObj);
    ...
    public void post_success(String retvalweb) {
        ...
        try {
            ...
            for (; i < jsArr.length(); i++) {
                ...
                Log.e("Shubham", "Description:-->"+desc+"\nLat:-->"+lat+"\nLang-->"+lng);
                //Log.e("OMG" + i, desc + "=" + lat + "=" + lng);

                curlatlng = new LatLng(new Double(lat), new Double(lng));
                temp = map.addMarker(new MarkerOptions().position(curlatlng).title(desc));
                temp.showInfoWindow();
                marker.add(temp);
                // Log.e("THANK","GOD");
            }
