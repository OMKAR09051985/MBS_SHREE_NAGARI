                    ...
                    public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
                        ...
                        if (str.indexOf("Select Beneficiary") > -1) {
                            ...
                            for(int i=0;i<allStr.length;i++)  {
                                Log.e("Shubham", "Beneficiary:----->  " + allStr[i]);
                            }
    ...
    public void addAccounts(String str) {
        ...
        try {
            ...
            for (int i = 0; i < noOfAccounts; i++) {
                ...
                // if (((accType.equals("SB")) || (accType.equals("CA")) || accType.equals("LO"))) && oprcd.equalsIgnoreCase("O") && withdrawalAllowed.equalsIgnoreCase("Y")) {
                if (((accType.equals("SB")) || (accType.equals("LO")) || (accType.equals("CA"))) && oprcd.equalsIgnoreCase("O") && withdrawalAllowed.equalsIgnoreCase("Y")) {
    ...
    private void addBeneficiaries(String retval) {
        ...
        try {
            ...
            for (int i = 1; i < noOfben; i++) {
                ...
                for(int ii = 1; ii < str2.length; ii++){
                   // Log.e("Shubham", "Beneficiary List:- " + str2[ii]);
                }
    ...
    class CallWebServiceSaveTransfer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            try {
                ...
                Log.e("Shubham", "CallWebServiceSaveTransfer_request: " + jsonObj.toString());
            } catch (JSONException je) {
                je.printStackTrace();
            }
        ...
        protected void onPostExecute(Void paramVoid) {
            ...
            try {
                String str = CryptoClass.Function6(var5, var2);
                jsonObj = new JSONObject(str.trim());
                Log.e("Shubham", "CallWebServiceSaveTransfer_responce: " + jsonObj);
                if (jsonObj.has("RESPCODE")) {
                    respcode = jsonObj.getString("RESPCODE");
                } else {
                    respcode = "-1";
...
//				txt_mmid.setText(txtMobID.getText().toString().trim());
    ...
    class CallWebServiceGetSrvcCharg extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void paramVoid) {
            ...
            try {
                String str = CryptoClass.Function6(var5, var2);
                jsonObj = new JSONObject(str.trim());
                Log.e("Shubham", "RTGS_Response: " + jsonObj);
    ...
    public void post_successGetSrvcCharg(String reTval) {
        Log.e("TAG", "RTGS_Response123: " + reTval);
        respcode = "";
        getTransferChargesrespdesc = "";
        act.frgIndex = 52;
