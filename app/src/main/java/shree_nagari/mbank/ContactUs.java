...
public class ContactUs extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flag == 0) {
           ...
           new CallWebServiceGetConfiguration().execute();
        }
    }
	/*@Override
    ...
    class CallWebServiceGetConfiguration extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            try {
				Log.e("Shubham", "CallWebServiceGetConfiguration_Inside");
                respcode = "";
                retval = "";
                respdesc = "";
				...
				Log.e("Shubham", "CallWebServiceGetConfiguration_Request:---->"+jsonObj.toString());
        ...
        protected void onPostExecute(Void paramVoid) {
            ...
            try {
				...
				Log.e("Shubham", "CallWebServiceGetConfiguration_Responce:---->"+jsonObj);
                ...
                if (respdesc.length() > 0) {
                    ...
                    if (retval.indexOf("FAILED") > -1) {
						...
						Log.e("Shubham", "CallWebServiceGetConfiguration_1");
                    } else {
						Log.e("Shubham", "CallWebServiceGetConfiguration_0");
                        post_success(retval);
