...
public class LoginActivity1 extends CustomWindow implements OnClickListener, LocationListener {
    // ProgressBar p_wait;
    Button btnLogin;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       tv_bankname = (TextView) findViewById(R.id.textViewBankName);
        ...
        Log.e("Shubham","---------------------in Login Activity 1----------------");

        et_custid = (EditText) findViewById(R.id.etCustId);
        et_mpin = (EditText) findViewById(R.id.etMpin);
        btnLogin = (Button) findViewById(R.id.button2);

        String custid = et_custid.getText().toString();
        String mpin = et_custid.getText().toString();
        btnLogin.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("Shubham", "Login Click Checking" + "\n" + "custid:-" + custid + "\n" + "mpin:-" + mpin);
            }
        });
        ...
        imeiNo = MBSUtils.getImeiNumber(this);
        mobNo = MBSUtils.getMyPhoneNO(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_register:
                Log.e("Shubham", "register Clicked");
                in = new Intent(this, Register.class);
                startActivity(in);
                finish();
                break;
            case R.id.txt_forgot_pass:
                Log.e("Shubham", "forget Clicked");
		...
		/*	boolean isNumeric;
            ...
            case R.id.locateus:
                Log.e("Shubham", "location Clicked");
