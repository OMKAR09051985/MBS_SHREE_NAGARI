...
public class CryptoClass 
{
	public static Map<String, Object> Function1() throws Exception 
	{
        ...
        Log.e("publicKey--","publicKey---"+publicKey);
    ...
    public static String Function7(String plainText, PublicKey publicKey) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
        cipher.init(Cipher.ENCRYPT_MODE, publicKey);
        return new String(cipher.doFinal(Base64.decodeBase64(plainText.getBytes())));
        //return new String(cipher.doFinal(encryptedText.getBytes()));
    }

    public static String Function8(String encryptedText, PublicKey publicKey) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
